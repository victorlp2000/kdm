 ...
 *
 */
public class TZFriendDataSearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.tz_friend_search);

		beginDateView = (EditText) findViewById(R.id.tzFriendDataSearchBegin);
		endDateView = (EditText) findViewById(R.id.tzFriendDataSearchEnd);
		...
		beginDateView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new DatePickerDialog(TZFriendDataSearchActivity.this,
