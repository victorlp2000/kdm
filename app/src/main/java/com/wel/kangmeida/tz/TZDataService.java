...
public class TZDataService extends Service {
	...
	public void listFriendData(String beginDate, String endDate, int max, int offset) {
		String url = AppConstat.APP_HOST + "/tz/getFriendData";
		...
		client.newCall(request).enqueue(new Callback() {
			...
			public void onResponse(Call call, Response response) throws IOException {
				...
				if (!"".equals(remoteText)) {
					Intent intent = new Intent(BTAction.getUpdateAction(BTPrefix.TZ));
	...
	public void listPaiMin(String beginDate, String endDate, int max, int offset) {
		new TZPaiMinThread(beginDate, endDate, max, offset).start();
	}
	...
	private class TZPaiMinThread extends Thread {
		private String beginDate;
		private String endDate;
		private int max;
		private int offset;

		public TZPaiMinThread(String beginDate, String endDate, int max,
				int offset) {
		...
		public void run() {
			...
			Intent pmIntent = new Intent(
					BTAction.getPaiMinAction(BTPrefix.TZ));
			try {
				url = new URL(AppConstat.APP_HOST + "/tz/listPaiMin");
				HttpURLConnection urlConn = (HttpURLConnection) url
						.openConnection();
				urlConn.setDoInput(true);// 字节流
				urlConn.setDoOutput(true);// 字节流
