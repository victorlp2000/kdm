 ...
 * 
 */
public class XYFriendDataSearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.xy_friend_search);

		beginDateView = (EditText) findViewById(R.id.xyFriendSearchBegin);
		endDateView = (EditText) findViewById(R.id.xyFriendSearchEnd);
		...
		beginDateView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				new DatePickerDialog(XYFriendDataSearchActivity.this,
